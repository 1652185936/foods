...
part 'account_export_recognition_item.g.dart';

@JsonSerializable()
class AccountExportRecognitionItem {
  const AccountExportRecognitionItem({
  ...
  factory AccountExportRecognitionItem.fromJson(Map<String, Object?> json) =>
      _$AccountExportRecognitionItemFromJson(json);
  ...
  Map<String, Object?> toJson() => _$AccountExportRecognitionItemToJson(this);
}
