...
class _UsersApi implements UsersApi {
  ...
  Future<void> deleteCurrentUser({
    required AccountDeletionInput body,
  ...
  Future<AccountDataExportResponse> exportCurrentUserData({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AccountDataExportResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late AccountDataExportResponse _value;
    try {
      _value = AccountDataExportResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<HealthProfileResponse> getCurrentHealthProfile({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HealthProfileResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late HealthProfileResponse _value;
    try {
      _value = HealthProfileResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<HealthProfileResponse> putCurrentHealthProfile({
    required HealthProfileInputModel body,
    Map<String, dynamic>? extras =
  ...
  Future<AppPreferencesResponse> getCurrentAppPreferences({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AppPreferencesResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late AppPreferencesResponse _value;
    try {
      _value = AppPreferencesResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
