...
class _RecognitionApi implements RecognitionApi {
  _RecognitionApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<RecognitionUploadResponse> createRecognitionUpload({
    required RecognitionUploadInput body,
    ...
    final _options = _setStreamType<RecognitionUploadResponse>(
    ...
    late RecognitionUploadResponse _value;
    try {
      _value = RecognitionUploadResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<CompletedRecognitionUploadResponse> completeRecognitionUpload({
    ...
    final _options = _setStreamType<CompletedRecognitionUploadResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late CompletedRecognitionUploadResponse _value;
    try {
      _value = CompletedRecognitionUploadResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<RecognitionResponse> createRecognition({
    ...
    required RecognitionCreateInput body,
    Map<String, dynamic>? extras =
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<RecognitionResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v1/recognitions',
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late RecognitionResponse _value;
    try {
      _value = RecognitionResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<RecognitionResponse> correctRecognition({
    required String recognitionId,
    required RecognitionCorrectionInput body,
    Map<String, dynamic>? extras =
